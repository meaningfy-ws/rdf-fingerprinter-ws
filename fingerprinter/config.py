...
RDF_FINGERPRINTER_FUSEKI_LOCATION = os.environ.get('RDF_FINGERPRINTER_FUSEKI_LOCATION', 'http://localhost')
RDF_FINGERPRINTER_FUSEKI_SERVICE = str(RDF_FINGERPRINTER_FUSEKI_PORT) + ":" + str(RDF_FINGERPRINTER_FUSEKI_LOCATION)
